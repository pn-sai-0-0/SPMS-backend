...
public class DailyActivity {
    ...
    /**
     * Convenience setter that accepts a primitive double so test code like
     * {@code da.setHoursWorked(8.0)} compiles without explicit BigDecimal casting.
     * Lombok generates setHoursWorked(BigDecimal) — this overload bridges the gap.
     */
    public void setHoursWorked(double hours) {
        this.hoursWorked = java.math.BigDecimal.valueOf(hours);
    }
}